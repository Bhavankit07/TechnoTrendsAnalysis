                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <form class="form-horizontal group-border-dashed" action="checkPassword.html" method="post">
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Email:</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control" required="true" id="email" name="username"
