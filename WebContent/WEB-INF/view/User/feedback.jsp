                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <f:form class="form-horizontal group-border-dashed" action="insertFeedback.html" method="post" modelAttribute="data">
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Title:</label>
                                                    <div class="col-sm-6">
                                                        <f:input type="text" path="feedbackTitle" class="form-control" required=""
                                                               placeholder="Type something"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Feedback Discription:</label>
                                                    <div class="col-sm-6">
                                                        <f:textarea required="" path="feedbackDescription" class="form-control"></f:textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
