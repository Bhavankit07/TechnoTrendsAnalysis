                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0 m-b-30">Reset Password</h4>

                                    <div class="row">
                                        <div class="col-lg-6">

                                            <form class="form-horizontal group-border-dashed" action="updatePassword.html" method="post">
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">OTP:</label>
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="OTP" type="text" onkeyup="match()" name="OTP" placeholder="OTP" required="true"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-control" id="email" name="confirm password" placeholder="confirm Password" type="password" required="true"/>
                                                    </div>
                                                </div>
