                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0 m-b-30">ADD COMPLAINT</h4>

                                    <div class="row">
                                        <div class="col-lg-6">

                                            <f:form class="form-horizontal group-border-dashed" action="insertComplaint.html" method="post" modelAttribute="data">
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Subject:</label>
                                                    <div class="col-sm-6">
                                                        <f:input type="text" path="complainName" class="form-control" required=""
                                                               placeholder="Type something"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Complaint Discription:</label>
                                                    <div class="col-sm-6">
                                                        <f:textarea required="" path="complainDescription" class="form-control"></f:textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-offset-3 col-sm-9 m-t-15">
                                                        <f:button type="submit" class="btn btn-primary waves-effect waves-light">
                                                            Submit
                                                        </f:button>
