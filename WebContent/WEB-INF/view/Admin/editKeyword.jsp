                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <f:form class="form-horizontal group-border-dashed" action="updateKeyword.html" method="post" modelAttribute="UKEYWORD">
                                                <f:hidden path="keywordId"></f:hidden>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Keyword Name:</label>
                                                    <div class="col-sm-6">
                                                        <f:input type="text" path="keywordName" class="form-control" required=""
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <f:textarea required="" path="keywordDescription" class="form-control"></f:textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
