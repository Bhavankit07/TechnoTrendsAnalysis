                                ...
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <c:forEach items="${list}" var="x">
                                            <tr>
                                                 <td><c:out value="${x.complainName }"></c:out></td>
                                                  <td><c:out value="${x.complainDescription }"></c:out></td>
                                                  <td><c:out value="${x.complainStatus }"></c:out></td>
                                                  <td><c:out value="${x.loginVO.getEmail() }"></c:out></td>
                                                <td>
                                                	<a href="replyComplain.html?id=${x.complainId }" > <button type="button" class="btn btn-success">Reply</button></a>
												</td>
                                            </tr>
                                            </c:forEach>
                                        </tbody>
