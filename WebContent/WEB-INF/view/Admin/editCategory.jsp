                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <f:form class="form-horizontal group-border-dashed" action="updateCategory.html" method="post" modelAttribute="UCATEGORY">
                                                <f:hidden path="categoryId"></f:hidden>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Category Name:</label>
                                                    <div class="col-sm-6">
                                                        <f:input type="text" path="categoryName" class="form-control" required=""
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <f:textarea required="" path="categoryDescription" class="form-control"></f:textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
