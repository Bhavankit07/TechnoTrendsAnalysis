                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0 m-b-30">ADD KEYWORD</h4>

                                    <div class="row">
                                        <div class="col-lg-6">

                                            <f:form class="form-horizontal group-border-dashed" action="insertKeyword.html" method="post" modelAttribute="KEYWORD">
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Keyword Name:</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" name="KeywordName" class="form-control" required
                                                               placeholder="Type something"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label">Keyword Discription:</label>
                                                    <div class="col-sm-6">
                                                        <textarea required name="KeywordDescription" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
