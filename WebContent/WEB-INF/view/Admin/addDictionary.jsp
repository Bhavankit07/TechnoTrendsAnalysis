                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                        			...
                        			<h4 class="header-title m-t-0 m-b-30">ADD DICTIONARY</h4>

                                    <div class="row">
                                        <div class="col-lg-6">

                                            <f:form class="form-horizontal group-border-dashed" action="insertDictionary.html" method="post" modelAttribute="DICTIONARY">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <textarea required name="dictionaryDescription" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
