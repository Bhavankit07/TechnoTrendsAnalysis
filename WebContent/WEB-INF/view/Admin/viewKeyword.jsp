                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        <c:forEach items="${keywordList}" var="k">
                                            <tr>
                                                <td>${k.keywordDescription}</td>
                                                <td>${k.keywordName}</td>
                                                <td><a href ="keywordDelete.html?x=${k.keywordId}"> Delete </a>
													<a href ="keywordEdit.html?x=${k.keywordId}"> Edit </a>
												</td>
                                            </tr>
                                            </c:forEach>
                                        </tbody>
